...
public final class PlaceholderManager {
    ...
    private static String applySimplePlaceholders(String text, ExtraData data, boolean repeatedPass) {
        for (SimplePlaceholder placeholder : SIMPLES) {
            ...
            try {
                ...
                Diagnostics.record("Placeholder", throwable);
    ...
    public static SortedSet<String> getMissingPlaceholderAPIPlaceholders() {
        return getMissingPlaceholders('%', '%');
    }

    public static SortedSet<String> getMissingNativePlaceholders() {
        return getMissingPlaceholders('{', '}');
    }
    ...
    private static SortedSet<String> getMissingPlaceholders(char opening, char closing) {
        SortedSet<String> result = new TreeSet<>();
        for (String placeholder : missingPlaceholders) {
            if (placeholder != null && placeholder.length() > 2
                    && placeholder.charAt(0) == opening
                    && placeholder.charAt(placeholder.length() - 1) == closing) {
