...
public final class AdvancedPlayerListAPI implements Listener, AutoCloseable {
    ...
    public synchronized void register(Plugin owner, AdvancedTabPlaceholder placeholder) {
        ensureOpen();
    ...
    private static final class Registration implements ParameterizedPlaceholder {
        ...
        private final AdvancedTabPlaceholder placeholder;

        private Registration(Plugin owner, String identifier, AdvancedTabPlaceholder placeholder) {
            this.owner = owner;
